...
try {
  buildSync({
    ...
    sourcemap: false,
    banner: {
      js: `// Happy Agent Easy v${version} - 包含所有依赖，无需安装\n`,
    },
    define: {
      '__VERSION': `"${version}"`,
    },
...
console.log("\n使用方式:");
console.log("  node skill.js list");
console.log("  node skill.js status <session-id>");
console.log("  node skill.js history <session-id>");
