...
var require_query = __commonJS({
  "lib/cmd/query.js"(exports2, module2) {
...
var require_create = __commonJS({
  "lib/cmd/create.js"(exports2, module2) {
    var { graphqlQuery } = require_api();
...
var require_update = __commonJS({
  "lib/cmd/update.js"(exports2, module2) {
    var { graphqlQuery } = require_api();
    var { showSuccess } = require_output();
    var { handleError: handleError2 } = require_errors();
...
var require_search = __commonJS({
  "lib/cmd/search.js"(exports2, module2) {
    ...
    module2.exports = { extractSnippet };
  }
});

// lib/cmd/search_cmd.js
var require_search_cmd = __commonJS({
  "lib/cmd/search_cmd.js"(exports2, module2) {
    var { graphqlQuery } = require_api();
    var { formatOutput } = require_output();
    var { handleError: handleError2 } = require_errors();
    var { extractSnippet } = require_search();
...
var require_history = __commonJS({
  "lib/cmd/history.js"(exports2, module2) {
    var { graphqlQuery } = require_api();
    var { formatOutput } = require_output();
    var { handleError: handleError2 } = require_errors();
    var yaml = require_js_yaml();
...
var require_version = __commonJS({
  "lib/cmd/version.js"(exports2, module2) {
    var { graphqlQuery } = require_api();
    var { formatOutput } = require_output();
    var { handleError: handleError2 } = require_errors();
    async function cmdVersion2(url, token, pageId, versionId, options) {
...
`);
          ...
          if (version.content) {
            const preview = options.fullContent ? version.content : version.content.substring(0, 200) + (version.content.length > 200 ? "\n...\uFF08\u7701\u7565\uFF09" : "");
            console.log(`
${preview}`);
          }
        }
